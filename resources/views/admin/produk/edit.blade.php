<x-app>
    <div class="card-header">
        <h5 class="m-0 font-weight-bold text-dark" style="text-align:center; font-size: 25px"> EDIT PRODUK
        </h5>
    </div>
    <div class="row">
        <div class="col-md-12">
                    ...
                    <form action="{{ url('admin/produk', $produk->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="nama_motif" id="nama_motif" value="{{$produk->nama_motif}}">
                                @error('nama_motif')
